...
import com.example.ddxz.hencoder.viewmodel.ProductViewModel
...
//        copy(arrayOf(Button(this)), arrayOfNulls(1))
        ...
        productViewModel.fetchActBanner(500)
        val httpLoggingInterceptor = HttpLoggingInterceptor()

        productViewModel.actBannerLiveData.observe(this, Observer {
